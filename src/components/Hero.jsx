...
export function Hero() {
  ...
  const words = ["Web Apps", "Websites", "Solutions", "Experiences"];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mt-6 text-xl text-gray-600 max-w-2xl">
              Create stunning, responsive web applications with modern tools and
              technologies. Fast, reliable, and built for the future with React,
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <button
                ...
                className="bg-gray-900 cursor-pointer text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                Start Building
              </button>
              <button className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg text-lg font-semibold hover:border-gray-900 hover:text-gray-900 transition-all duration-300">
                View Demo
              </button>
            </div>
          ...
          <div className="relative">
              ...
              <div className="">
                <div className="flex justify-center items-center space-x-8 py-8">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-10 left-1/2 transform -translate-x-1/2 text-xs font-semibold text-gray-700">
                      Vite
                    </div>
                  </div>
            ...
            {/* Background Elements */}
            <div className="absolute top-10 -right-10 w-20 h-20 bg-blue-300 rounded-full opacity-30 animate-pulse"></div>
            <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-purple-300 rounded-full opacity-30 animate-pulse delay-1000"></div>
          </div>
        </div>
      </div>
    </section>
